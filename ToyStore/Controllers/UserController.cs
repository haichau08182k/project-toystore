...
namespace ToyStore.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult ConfirmEmail(int ID)
        {
            ...
            SentMail("Mã xác minh tài khoản ToyStore", email, "haichau0818@gmail.com", "google..haichau0818", "<p>Mã xác minh của bạn: " + captcha + "<br/>Hoặc xác minh nhanh bằng cách click vào link: " + urlBase + "/User/ConfirmEmailLink/" + ID + "?Capcha=" + captcha + "</p>");
            return View();
        }
        [HttpGet]
